...
print("This is the text before Summarization:")
...
print("This is the text after Summarization:")
print(summary)
print("--------------------------------------------------------------------------------------------------------")
print("This is length of text before Summarization:")
print(len(document1))
print("--------------------------------------------------------------------------------------------------------")
print("This is length of text after Summarization:")
print(len(summary))
